...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	try
	{
		...
		Log::WritePolishLog(lex.lextab, *log.stream);


		Gen::Generator Gener(lex.lextab, lex.idtab, "D:\\KIP-2024\\KIP-2024\\ASM\\asm.asm");
	...
	system("start D:\\KIP-2024\\KIP-2024\\ASM\\compilation.bat");
	system("pause");
